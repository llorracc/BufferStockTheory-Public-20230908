...
example = IndShockConsumerType(**params_test)
example.track_vars=[ 'mNrm','cNrm','pLvl','PermShk','TranShk']
example.cycles = 0
example.tolerance=example.tolerance/100
# Solve for the consumption function
example.track_vars=[ 'mNrm','cNrm','pLvl','PermShk','TranShk']
example.solve()
example.AgentCount=3
shocks_off = {
    'PermShkStd': [0.],
    'PermShkCount': 1,
    'TranShkStd': [0.0],
...
example = IndShockConsumerType(**params_test)
example.tolerance = example.tolerance/10
example.cycles = 0
example.solve()
...
# %% tags=[]
# Base simulation
# example.PermShkStd = [0.0]
# example.TranShkStd = [0.0]
# example.PermShkCount = 1
# example.TranShkCount = 1
example.UnempPrb = 0.0
example.update_income_process()
